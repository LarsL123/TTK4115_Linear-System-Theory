...
typedef struct {
  ...
  real_T Elevoffset;                   /* '<Root>/Elev offset' */
  real_T ElevationTransferFcn;         /* '<S2>/Elevation: Transfer Fcn' */
  real_T TmpSignalConversionAtToFile3Inp[6];
  real_T Gain1[3];                     /* '<S10>/Gain1' */
  real_T biaselev;                     /* '<S3>/bias elev' */
  real_T lambda;                       /* '<S7>/Integrator' */
  real_T AddConstant;                  /* '<S3>/Add Constant' */
  real_T Switch2;                      /* '<S5>/Switch2' */
  real_T Switch_j[6];                  /* '<S5>/Switch' */
  real_T P_k_hat[36];                  /* '<S5>/Switch1' */
  real_T p_ref;                        /* '<Root>/Step' */
  real_T e_dot_ref;                    /* '<Root>/Constant' */
  real_T Sum[2];                       /* '<S8>/Sum' */
  real_T Vs;                           /* '<Root>/Vs0' */
  ...
  real_T y[6];                         /* '<Root>/MATLAB Function' */
  real_T x_k1_priori[6];               /* '<S5>/Prediction step' */
  real_T P_k1_priori[36];              /* '<S5>/Prediction step' */
  real_T y_j[2];                       /* '<S3>/MATLAB Function' */
  real_T euler_rates[3];
           /* '<S3>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
...
typedef struct {
  ...
  real_T UnitDelay_DSTATE[36];         /* '<S5>/Unit Delay' */
  real_T UnitDelay_DSTATE_l[2];        /* '<Root>/Unit Delay' */
  ...
  struct {
    void *LoggedData;
  } Measurement_PWORK;                 /* '<Root>/Measurement' */

  struct {
    void *LoggedData;
  } P_khat_PWORK;                      /* '<Root>/P_k hat' */
...
typedef struct {
  ...
  real_T Integrator_CSTATE_h[2];       /* '<S8>/Integrator' */
} X_heli_q8_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_h[2];    /* '<S8>/Integrator' */
} XDis_heli_q8_T;
...
struct P_heli_q8_T_ {
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: -2 * pi /4096
                                        ...
                                        */
  real_T Elevoffset_Bias;              /* Expression: -0.5
  ...
  real_T Gain1_Gain[9];             /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
                                     ...
                                     */
  real_T biaselev_Bias;                /* Expression: 0.0125
                                        * Referenced by: '<S3>/bias elev'
                                        */
  real_T Integrator_IC;                /* Expression: 0
                                        * Referenced by: '<S7>/Integrator'
                                        */
  real_T AddConstant_Bias;             /* Expression: 0.032
 ...
 * '<S9>'   : 'heli_q8/IMU/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S10>'  : 'heli_q8/IMU/IMU'
 * '<S11>'  : 'heli_q8/IMU/MATLAB Function'
 * '<S12>'  : 'heli_q8/Kalmann/Correction step'
 * '<S13>'  : 'heli_q8/Kalmann/Prediction step'
 */
